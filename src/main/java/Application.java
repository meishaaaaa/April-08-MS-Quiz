...
import Functions.InitializeParkingLot;
import Functions.ParkCar;
...
public class Application {
    ...
    public static void init(String initInfo) {
        ...
        try {
            String[] infoSet = Tools.parseString(initInfo, splitItem, splitLimit);
            InitializeParkingLot parkingLot = new InitializeParkingLot();
            parkingLot.initial(infoSet);
    ...
    public static String fetch(String ticket) throws InvalidTicketException {
        ...
        String[] infoSet = Tools.parseString(ticket, splitItem, splitLimit);
        Fetch fetch = new Fetch();

        return fetch.fetch(infoSet) ? infoSet[2] : null;
    }
